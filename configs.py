...
class Config(object):
  ...
  ANUSHKA_DB_CHANNEL = int(os.environ.get("ANUSHKA_DB_CHANNEL", "-1001602208028"))
  ...
  FILE_TO_LINK_APPURL = os.environ.get("FILE_TO_LINK_APPURL", "https://mrakfilestore-8b35295654b7.herokuapp.com")
  FILE_TO_LINK_LOG = int(os.environ.get("FILE_TO_LINK_LOG", "-1001602208028"))
  ...
  ANUSHKA_FILE_TO_LINK_LOG = int(os.environ.get("FILE_TO_LINK_LOG", "-1001602208028"))
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001602208028"))
  ANUSHKALOG_CHANNEL = int(os.environ.get("ANUSHKA_LOG_CHANNEL", "-1001602208028"))
