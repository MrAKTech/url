...
class Config(object):
  ...
  ANUSHKA_FILE_TO_LINK_APPURL = os.environ.get("FILE_TO_LINK_APPURL", "https://mraklinkzz-c342d83c238c.herokuapp.com")
  ANUSHKA_FILE_TO_LINK_LOG = int(os.environ.get("FILE_TO_LINK_LOG", "-1002026821864"))
